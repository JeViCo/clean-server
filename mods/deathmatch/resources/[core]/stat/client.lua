...
function resStatRender()
	...
	if #serverRows == 0 then
		dxDrawText("Клиент",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1,"default_bold-small","center")
	else
		dxDrawText("Клиент",sx-235,y-20,sx-235,y-20,tocolor(255,255,255,255),1,"default_bold-small","center")
	end
	dxDrawRectangle(x-10,y,150,height,tocolor(0,50,0,150))
	y = y + 5
	for i, row in ipairs(rows) do
		local text = row[1]:sub(0,15)..": "..row[2]
		dxDrawText(text,x+1,y+1,150,15,tocolor(0,0,0,255),1,"default_bold-small")
		dxDrawText(text,x,y,150,15,tocolor(255,255,255,255),1,"default_bold-small")
		y = y + 15
	end
	...
	if #serverRows ~= 0 then
		...
		local y = sy/2-height/2
		dxDrawText("Сервер",sx-75,y-20,sx-75,y-20,tocolor(255,255,255,255),1,"default_bold-small","center")
